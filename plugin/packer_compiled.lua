...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/eyad/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/eyad/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-better-whitespace"] = {
    loaded = true,
    path = "/home/eyad/.local/share/nvim/site/pack/packer/start/vim-better-whitespace",
  ...
  ["vim-polyglot"] = {
    loaded = true,
    path = "/home/eyad/.local/share/nvim/site/pack/packer/start/vim-polyglot",
  ...
  ["which-key.nvim"] = {
    ...
    loaded = true,
    path = "/home/eyad/.local/share/nvim/site/pack/packer/start/which-key.nvim",
